...
from redbird.repos import MongoRepo, MemoryRepo
...
def get_repository(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        *args: Additional arguments to pass to the repository constructor
        **kwargs: Additional keyword arguments to pass to the repository constructor
        
    Returns:
        TemplateRepo or None: Repository instance or None if type not supported
    """
